...
<html lang="en">
   ...
   <body>
      ...
      <script type="text/javascript" src="{{ asset('map/L.Control.ZoomBox.js') }}" defer></script>
      ...
      <script src="https://cdnjs.cloudflare.com/ajax/libs/leaflet-minimap/3.6.1/Control.MiniMap.min.js" defer></script>
      <script>
    // Definimos la ruta base globalmente
    window.baseSectorUrl = "{{ url('/sector') }}";
</script>
      <script type="text/javascript" src="{{ asset('map/start.js') }}" defer></script>
      <script type="text/javascript" src="{{ asset('map/spin.min.js') }}" defer></script>
      <script type="text/javascript" src="{{ asset('map/leaflet.spin.min.js') }}" defer></script>
